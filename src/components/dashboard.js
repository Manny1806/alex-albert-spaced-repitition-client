...
import { fetchQuestionData, submitQuestionAnswer, incrementQuestionNumber, resetQuestionData } from '../actions/questions.js';
...
export class Dashboard extends React.Component {
  ...
  resultDisplay() {
    if (this.props.results.bool === undefined) {
      ...
      return (<div></div>);
        ...
        return (
          <div>
            <div className="attempts-passed-container">
  ...
  displayName() {
    if (this.props.results.bool === undefined) {
      return (
        <span className="pokemonName">Who's that Pokemon?</span>
      );
    } else {
        return (
        <span className="pokemonName">{this.props.results.name}</span>
      );
    }
  }
